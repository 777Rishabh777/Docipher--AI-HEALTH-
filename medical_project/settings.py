...
# False in production, True only for local dev
...
# ─── Database ─────────────────────────────────────────────────────────────────
# Uses Neon (PostgreSQL) in production, SQLite locally if DATABASE_URL not set
...
# ─── Static Files (WhiteNoise serves them on Vercel — no S3 needed) ───────────
STATIC_URL = '/static/'
...
# Use Cloudinary in production, local filesystem locally
